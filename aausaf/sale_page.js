...
async function getdata ()
{
    try
    {
       let res = await fetch(`https://aausaaf.github.io/fabwallysapi/db.json`)
        data = await res.json()
        data = data.arrays
...
async function test2(){
    let res2=await fetch("https://aausaaf.github.io/fabwallysapi/db.json");
