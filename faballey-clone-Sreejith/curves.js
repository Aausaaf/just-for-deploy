...
let url="https://aausaaf.github.io/fabwallysapi/db.json";
...
function displayData(data,container)
{
    ...
    data.forEach(element => {
        ...
        {  
            ...
            localStorage.setItem('checkoutId',JSON.stringify(element));
            localStorage.setItem('pageName',JSON.stringify(element));
...
url="https://aausaaf.github.io/fabwallysapi/db.json"; 
